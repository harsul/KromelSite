...
namespace KromelSite.Controllers
{
    public class UrunGruplariController : Controller
    {
        ...
        public UrunGruplariController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: UrunGruplari/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: UrunGruplari/Create
